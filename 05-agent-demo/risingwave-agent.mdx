...
## Step 1: Create the file 'agent.py', this will serve as a dataclass for your RisingWave agent.
...
## Step 2: Create the file 'risingwave-agent.py', this will actually instance of the Agent
