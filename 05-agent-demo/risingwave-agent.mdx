...
Follow the (tutorial)[https://docs.risingwave.com/ingestion/advanced/generate-test-data#number] to create a load generator.
...
Feel free to experiment with more prompts and try out with your own data! Similarly, you can use any of the [demos](/ingestion/advanced/generate-test-data) in the and test the streaming data in those directories.
