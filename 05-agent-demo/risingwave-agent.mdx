...
class MessageHistory:
    ...
    def format_for_api(self) -> list[dict[str, Any]]:
        ...
        return result
```
This first class is dedicated to creating a message history for the agent. Without this class the agnet would lack the ability to contextualize user queries and would require specific details for every continuous query.
